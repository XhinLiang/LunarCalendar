package xhinliang.lunarcalendar;


import xhinliang.lunarcalendar.utils.TextUtils;
 ...
 */
 class DPCManager {
    private static final HashMap<Integer, HashMap<Integer, LunarCalendar[][]>> DATE_CACHE = new HashMap<>();
    ...
    LunarCalendar[][] obtainDPInfo(int year, int month) {
        HashMap<Integer, LunarCalendar[][]> dataOfYear = DATE_CACHE.get(year);
